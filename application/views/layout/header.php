...
<head>
    ...
    <title>Cankul Syaria | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Cankul</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block"><?= $this->session->userdata('data')->username ?></a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item <?= ($uri1 == 'beneficiary' || $uri1 == 'funder') ? 'menu-open' : '' ?> ">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>funder" class="nav-link <?= $uri1 == 'funder' ? 'active' : '' ?> ">
                                        <i class="nav-icon far fa-calendar-alt"></i>
                                        <p>
                                            funder
                                            <!-- <span class="badge badge-info right">2</span> -->
